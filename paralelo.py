...
if __name__ == "__main__":
    ...
    def main(): # función main
        eleccion = solicitar_introducir_numero_extremo(Fore.CYAN +"¿Quieres ejecutar el programa en paralelo? 1: No, 2: Si, 3: Ver medias de tiempo de ejecución, 4: Salir", 1, 3) ; print(Fore.RESET) # solicito al usuario que introduzca un número entre 1 y 3
